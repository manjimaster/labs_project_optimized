<!-- Intro Section -->
    <div class="hero-section">
        ...
        <div id="hero-slider" class="owl-carousel">
            <div class="item  hero-item" data-bg="/storage/images/modified/01.jpg"></div>
            <div class="item  hero-item" data-bg="/storage/images/modified/02.jpg"></div>
        </div>
    </div>
    <!-- Intro Section -->
                    ...
                    <div class="owl-carousel" id="testimonial-slide">
                        ...
                        <div class="testimonial">
                            ...
                            <div class="client-info">
                                <div class="avatar">
                                    <img src="/storage/images/modified/avatar/01.jpg" alt="">
                                </div>
                        ...
                        <div class="testimonial">
                            ...
                            <div class="client-info">
                                <div class="avatar">
                                    <img src="/storage/images/modified/avatar/02.jpg" alt="">
                                </div>
                                <div class="client-name">
                                    <h2>Michael Smith</h2>
                                    <p>CEO Company</p>
    ...
    <div class="team-section spad">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="member">
                        <img src="/storage/images/modified/team/1.jpg" alt="">
                ...
                <div class="col-sm-4">
                    <div class="member">
                        <img src="/storage/images/modified/team/2.jpg" alt="">
                        <h2>Christinne Williams</h2>
                ...
                <div class="col-sm-4">
                    <div class="member">
                        <img src="/storage/images/modified/team/3.jpg" alt="">
                        <h2>Christinne Williams</h2>
